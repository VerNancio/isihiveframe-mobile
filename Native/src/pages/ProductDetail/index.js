...
const ProductDetail = ({ route }) => {
    ...
    const [hoursMach, setHoursMach] = useState(3);

    const trySave = () => {
        console.log(hoursMach)
        console.log(hoursPerson)
        console.log('aaa')
    };
            ...
            <View style={styles.container}>
                ...
                <View style={{gap: 12}}>
                    ...
                    <View>
                        ...
                        <DropdownComponent state={{get: hoursPerson, set: setHoursPerson}} styleProp={stylesDropdown} statementTitle="HORAS TRABALHADAS (DIA):" statement={jsonDetails['productName']} />
                ...
                <View style={{gap: 12}}>
                    ...
                    <View>
                        ...
                        <DropdownComponent state={{get: hoursMach, set: setHoursMach}} styleProp={stylesDropdown} statementTitle="HORAS-MÁQUINA TRABALHADAS (DIA):" statement={jsonDetails['productName']} />
